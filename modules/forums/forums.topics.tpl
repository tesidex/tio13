...
<!-- BEGIN: FORUMS_SECTIONS -->
    <table class="table table-striped">
      <thead>
        <th class="width5"></td>
        <th class="width45">{PHP.L.Subforums}</td>
...
<!-- END: FORUMS_SECTIONS -->
    ...
    <table class="table table-striped">
      <thead>
        <th class="width5"></td>
        <th class="width45">{FORUMS_TOPICS_TITLE_TOPICS} / {FORUMS_TOPICS_TITLE_STARTED}</td>
        <th class="centered width30">{FORUMS_TOPICS_TITLE_LASTPOST}</td>
        <th class="centered width10">{FORUMS_TOPICS_TITLE_POSTS}</td>
        <th class="centered width10">{FORUMS_TOPICS_TITLE_VIEWS}</td>
      </thead>
<!-- BEGIN: FORUMS_TOPICS_ROW -->
      <tr>
        <td class="centered vmiddle">{FORUMS_TOPICS_ROW_ICON}</td>
        <td>
