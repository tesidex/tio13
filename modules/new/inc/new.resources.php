...
$R['new_submitnewnew'] = '<a href="{$sub_url}" rel="nofollow">'.$L['Submitnew'].'</a>';
...
$R['list_more'] =' <span class="readmore"><a href="{$new_url}" title="'.$L['ReadMore'].'">'.$L['ReadMore'].'</a></span>';

/**
 * New Icons
 */

$R['new_code_redir'] = '<script type="text/javascript">location.href="{$redir}"</script>Redirecting...';
$R['new_icon_file'] = '<img class="icon" src="{$icon}" alt="'.$L['File'].'" />';
$R['new_icon_file_default'] = 'images/icons/'.$cfg['defaulticons'].'/new.png';
$R['new_icon_file_path'] = 'images/filetypes/default/{$type}.png';
