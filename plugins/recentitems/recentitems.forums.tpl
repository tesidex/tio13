...
<!-- BEGIN: TOPICS_ROW -->
    <tr>
      <td class="centered vmiddle {FORUM_ROW_ODDEVEN}">{FORUM_ROW_ICON}</td>
      ...
      <td class="vmiddle {FORUM_ROW_ODDEVEN}">
        {FORUM_ROW_UPDATED}<span class="spaced">{PHP.cfg.separator}</span>{FORUM_ROW_LASTPOSTER}<br />
        {FORUM_ROW_TIMEAGO}
      </td>
      <td class="centered vmiddle {FORUM_ROW_ODDEVEN}">{FORUM_ROW_POSTCOUNT}</td>
      <td class="centered vmiddle {FORUM_ROW_ODDEVEN}">{FORUM_ROW_VIEWCOUNT}</td>
    </tr>
<!-- END: TOPICS_ROW -->
<!-- BEGIN: NO_TOPICS_FOUND -->
    <tr>
      <td class="centered" colspan="5">{PHP.L.recentitems_nonewposts}</td>
    </tr>
<!-- END: NO_TOPICS_FOUND -->
  </table>
