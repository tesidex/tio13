<!-- BEGIN: MAIN -->
<script src="{PHP.cfg.plugins_dir}/block/js/block.admin.js" type="text/javascript"></script>
<div id="catgenerator"> <div style="display:none">{MAINCATEGORY}</div>
	<table class="cells">
		<tr>
			<td class="coltop width30">{PHP.L.Category}</td>
			<td class="coltop width10">{PHP.L.BlockCount}</td>
			<td class="coltop width10">{PHP.L.Blockautocut} *</td>
		...
		<tr class="blockcat">
			...
			<td colspan="2" class="cat_exists" style="color:red; display:none;">{PHP.L.Blockcat_exists}</td>
	...
	<p class="small">* {PHP.L.Blockautocutdesc}</p>
